package net.prangellplays.pstranslate.config;
...
public class ConfigUI extends MidnightConfig {
     ...
     */
    @Entry(width = 300) public static String acousticModelPath = "C:\\Users\\ewanp\\AppData\\Roaming\\.minecraft\\versions\\pstranslate\\models\\vosk-model-small-en-us-0.15";
